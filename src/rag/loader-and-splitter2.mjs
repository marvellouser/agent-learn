...
console.log('正在创建向量储存');

const vectorstores = await MemoryVectorStore.fromDocuments(splitDocuments, embeddings);

console.log('向量储存创建完成');
...
for (const question of questions) {
  ...
  const scoredResults = await vectorstores.similaritySearchWithScore(question, 2);
